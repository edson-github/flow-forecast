...
def make_config_file(flow_file_path: str, gage_id: str, station_id: str, weight_path: str = None):
    the_config = {
        ...
        "model_type": "PyTorch",
        "model_params": {"number_time_series": 3, "seq_len": 36},
        "dataset_params": {
            "class": "default",
        ...
        "GCS": True,
        "wandb": {
            "name": f"flood_forecast_{gage_id}",
            "tags": [
                gage_id,
                station_id,
                "MultiAttnHeadSimple",
